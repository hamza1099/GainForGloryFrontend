...
const BiblePlans = () => {
  return (
    <main className="hm--main">
        ...
        <div className="hm--plans-grid">
          ...
          <div className="hm--plan-card">
            ...
            <div className="hm--card-content">
              ...
              <p className="hm--card-description">
                Build spiritual foundations through daily prayer and consistent
                scripture engagement.
              </p>
              <button className="hm--start-button">Start Plan</button>
            </div>
          </div>
          ...
          <div className="hm--plan-card">
            ...
            <div className="hm--card-content">
              ...
              <p className="hm--card-description">
                Finding rest and quiet for your soul in times of overwhelming
                worry.
              </p>
              <button className="hm--start-button">Start Plan</button>
            </div>
          ...
          <div className="hm--plan-card">
            ...
            <div className="hm--card-content">
              ...
              <p className="hm--card-description">
                Discovering Gods unique design for your life and your specific
                calling.
              </p>
              <button className="hm--start-button">Start Plan</button>
            </div>
          ...
          <div className="hm--plan-card">
            ...
            <div className="hm--card-content">
              ...
              <p className="hm--card-description">
                Cultivating a resilient spirit that stands firm regardless of
                the seasons of life.
              </p>
              <button className="hm--start-button">Start Plan</button>
            </div>
      ...
      {/* Hero Section: Active Journey Card */}
          ...
          <div className="hm--hero-overlay">
            <div className="hm--hero-content">
              <div className="hm--hero-text">
                <h2 className="hm--hero-title">Walking in Discipline</h2>
                <div className="hm--hero-progress">
                  <div className="hm--progress-bar">
                    <div className="hm--progress-fill"></div>
                  </div>
                  <span className="hm--progress-text">2/5 Days Complete</span>
                </div>
              </div>
              <button className="hm--continue-button">
      ...
      <section className="hm--curriculum-section">
        ...
        <div className="hm--timeline">
          {/* Day 1: Completed */}
          <div className="hm--timeline-item hm--timeline-completed">
            ...
            <div className="hm--timeline-content">
              <div className="hm--timeline-header">
                <h4 className="hm--timeline-day-title">Day 1: Self-Control</h4>
                <span className="hm--timeline-status hm--status-completed">
                  Completed
                </span>
              </div>
              <p className="hm--timeline-description">
                Understanding the biblical foundations of restraining the flesh
          ...
          <div className="hm--timeline-item hm--timeline-completed">
            ...
            <div className="hm--timeline-content">
              ...
              <p className="hm--timeline-description">
                The call to labor faithfully in whatever station God has placed
                you.
              </p>
            </div>
          </div>
          ...
          {/* Day 3: Active */}
          <div className="hm--timeline-item hm--timeline-active">
            ...
            <div className="hm--timeline-content">
              ...
              <p className="hm--timeline-description">
                Surrendering your will to the Divine path even when the road is
                narrow.
              </p>
          ...
          <div className="hm--timeline-item hm--timeline-locked">
            ...
            <div className="hm--timeline-content">
              <h4 className="hm--timeline-day-title">Day 4: Perseverance</h4>
              <p className="hm--timeline-description">
          ...
          <div className="hm--timeline-item hm--timeline-locked">
            ...
            <div className="hm--timeline-content">
              ...
              <p className="hm--timeline-description">
                Culminating the plan with the most vital tools for maintaining a
                disciplined soul.
              </p>
            </div>
          </div>
      ...
      {/* Day 2: Diligence - Detailed Content Section */}
        ...
        <div className="hm--detail-container">
          ...
          <div className="hm--detail-header">
            ...
            <div className="hm--detail-header-overlay">
              <div className="hm--detail-breadcrumb">
                <span className="material-symbols-outlined hm--back-icon">
                  arrow_back
                </span>
                <span className="hm--breadcrumb-text">
                  Walking in Discipline
                </span>
              </div>
              <h2 className="hm--detail-title">Day 2 - Diligence</h2>
          ...
          <div className="hm--detail-scripture">
            <div className="hm--scripture-icon-wrapper">
              ...
              <h3 className="hm--scripture-title">Proverbs 13:4</h3>
            </div>
          ...
          <div className="hm--devotional-section">
            ...
            <div className="hm--devotional-content">
              ...
              <p className="hm--devotional-paragraph">
                Are you giving your best in your spiritual pursuits? Diligence
                is not about perfection but consistent, steady effort. Today,
                ask God to help you stay focused on the tasks He has set before
                you.
              </p>
            </div>
          </div>
          ...
          <div className="hm--reflection-section">
            ...
            <div className="hm--reflection-card">
              ...
              <textarea
                ...
                rows={4}
              ></textarea>
              <button className="hm--mark-complete-button">
