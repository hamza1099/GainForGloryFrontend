...
// import {
//   agoraCallLeaveService,
//   agoraInfoService,
//   agoraSessionEndingInfoService,
//   agoraStartRecordingService,
//   agoraSudentInfoService,
//   agoraTutorInfoService,
...
//   // State for search parameters (URL search query)
//   const searchParams = useSearchParams();
//   const encString: any = searchParams.get("data")
...
//         encString: encString,
//       };
//       let response = await agoraInfoService(data);
//       if (response.result) {
//         setMsg(AppMessage.waitMsg);
//         sessionId = response.result.sessionId;
//         const channel = response.result.channelName;
//         const token = response.result.token;
//         const tutorUid = response.result.tutorUid;
//         handleJoinChannel(tutorUid, token, channel);
//       }
//     } catch (err) {
...
//   const getStudentProfile = async (user_uid: number) => {
//     try {
//       let data = {
//         user_uid,
//       };
//       let response = await agoraSudentInfoService(data);
//       if (response.result) {
//         const updatedProfile = { ...response.result, user_uid };
...
//   const getTutorProfileInfo = async () => {
//     try {
//       let data = {
//         session_id: sessionId,
//       };
//       let response = await agoraTutorInfoService(data);
//       if (response.result) {
//         setTutorProfile(response.result);
//       }
//     } catch (err) {
//       setError(AppMessage.requestFailed);
//     }
...
//         session_id: sessionId,
//       };
//       let response = await agoraSessionEndingInfoService(data);
//       if (response.result === 0) {
//         setError(AppMessage.sessionExpire);
//         handleLeaveChannel();
//       } else {
//         setSessionExpiryTime(response.result);
//         setCountdownTime(response.result);
//       }
//     } catch (err) {
//       setError(AppMessage.requestFailed);
//     }
...
//         session_id: sessionId,
//       };
//       let response = await agoraCallLeaveService(data);
...
//         session_id: sessionId,
//       };
//       let response = await agoraStartRecordingService(data);
//       if (response.result) {
//         recordingStarted = true;
//         console.log("Recording started successfully");
//       } else {
//         setTimeout(agoraStartRecording, 30000); // Retry after 30 seconds
//       }
//     } catch (err) {
//       setError(AppMessage.requestFailed);
//       setTimeout(agoraStartRecording, 30000);
//     }
//   };
...
//     if (!recordingStarted && remoteUsersRef.current.length === 1) {
//       agoraStartRecording();
//     }
...
const VideoCallScreen = (props: Props) => {
  return (
